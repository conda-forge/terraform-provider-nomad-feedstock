...
validate_recipe_outputs "terraform-provider-nomad-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="terraform-provider-nomad-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi